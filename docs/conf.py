...
# -*- coding: utf-8 -*-
#
# evolvability-playground-concept documentation build configuration file, created by
...
project = u'Evolvability Playground Concept'
...
htmlhelp_basename = 'evolvability-playground-conceptdoc'
...
latex_documents = [
    (master_doc, 'evolvability-playground-concept.tex',
     u'Evolvability Playground Concept Documentation',
...
man_pages = [
    (master_doc, 'evolvability-playground-concept',
     u'Evolvability Playground Concept Documentation',
     [author], 1)
]
